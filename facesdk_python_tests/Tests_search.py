...
def facesdk_setup(facesdk):
    ...
    face = read_image_bytes(FACE_3_PATH)
...
def test_search_url(facesdk_setup):
    ...
    response = create_dictionary(facesdk.search_api.search(
        SearchRequest(
            group_ids=[group_id],
            image=ImageFieldsImage(image_url='https://img.freepik.com/free-photo/portrait-beautiful-blond-woman-with-trendy-hairstyle_23-2149430891.jpg?t=st=1712577121~exp=1712577721~hmac=e4fb2fa9517e9bf0953bcc7eda15059d131fec68541bee602b8885f6e99bbc9b'),
        ),
    ))
    standard_assertions(response, person_id)
